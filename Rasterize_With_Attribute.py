...
from .Rasterize_With_Attribute_provider import RasterizeWithAttributeProvider
...
class RasterizeWithAttributePlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = RasterizeWithAttributeProvider()
