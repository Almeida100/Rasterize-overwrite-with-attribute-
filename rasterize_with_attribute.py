...
from .rasterize_with_attribute_provider import Rasterize_with_attributeProvider
...
class Rasterize_with_attributePlugin(object):
    ...
    def initProcessing(self):
        ...
        self.provider = Rasterize_with_attributeProvider()
